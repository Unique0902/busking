...
const Login = ({ authService, userRepository }) => {
  ...
  return (
    <section className='w-screen h-screen'>
      ...
      <section className='bg-blue-300 py-48 flex flex-row justify-center items-center rounded-xl'>
        <img
        ...
        <div className='w-1/3 ml-32'>
          <h2 className='text-white font-sans text-5xl font-semibold mb-6'>
            당신만의 노래 리스트를 생성하세요.
          </h2>
          <p className='text-white font-sans text-xl font-normal '>
            노래책은 노래리스트를 여러 개 만들 수 있어요. 각 리스트마다 주제를
            정해놓고 알맞은 곡을 저장해보세요.
          </p>
        </div>
      </section>
      <section className='bg-blue-500 py-48 flex flex-row justify-center items-center rounded-xl'>
        <div className='w-1/3 mr-32'>
          <h2 className='text-white font-sans text-5xl font-semibold mb-6'>
            당신의 애창곡을 검색하여 플레이리스트에 추가하세요.
          </h2>
          <p className='text-white font-sans text-xl font-normal '>
            노래책은 다양한 장르의 노래들의 검색을 지원해요. 부를 수 있는 다양한
            노래들을 검색해 보고 부르고 싶은 노래들을 플레이리스트에
            추가해보세요.
          </p>
        </div>
        <img
