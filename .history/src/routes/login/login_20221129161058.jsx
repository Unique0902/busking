  ...
  return (
    <section className='w-screen h-screen'>
      <section className='p-10 bg-white'>
        <Login_nav />
        <main className=' max-w-2xl pt-36 pb-24 m-auto'>
      ...
      <section className='bg-blue-600 flex flex-row justify-around'>
        <img
          src={require('../../img/screenMakePlaylist.png')}
          alt=''
          className=' h-96 w-96 mr-3'
        />
        <h2 className='text-white font-sans text-4xl font-bold'>
          당신만의 노래 리스트를 생성하세요.
        </h2>
      </section>
      <section>
