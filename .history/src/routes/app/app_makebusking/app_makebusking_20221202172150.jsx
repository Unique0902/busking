        ...
        <MainSec isFullSize={false}>
          ...
          <MainRow title={'최대 곡수 제한'}>
            <input
              ...
              className='border-black border-2 p-2 rounded-xl w-2/12 max-md:w-1/2 font-sans text-lg'
            />
          </MainRow>
          <MainRow title={'방 제목 설정'}>
            <input
              ...
              className='border-black border-2 p-2 rounded-xl w-1/3 max-md:w-full font-sans text-lg'
            />
          </MainRow>
          <button
            onClick={() => {
