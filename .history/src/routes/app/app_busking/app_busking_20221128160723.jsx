...
const App_busking = ({ buskingRepository }) => {
  ...
  return (
    <>
      ...
      <section className='w-3/4 m-auto bg-gray-300 rounded-3xl text-center py-4 px-2 mb-4'>
      ...
      <section className='bg-white rounded-2xl m-auto w-full mt-8 px-10 py-5 relative'>
