  ...
  return (
    <>
      ...
      <section className='bg-white rounded-2xl m-auto w-3/4 mt-8 px-10 py-5 relative'>
        <section className='relative flex flex-row justify-center items-center mb-6'>
          <h1 className='mt-2 text-center font-sans text-gray-600 font-semibold text-xl'>{`현재 플레이리스트: ${
