  ...
  return (
    <>
      ...
      <section className='bg-white rounded-2xl m-auto w-3/4 mt-8 px-10 py-5 relative'>
        <section className='relative flex flex-row justify-around items-center mb-6'>
          <h1 className=' text-center font-sans text-zinc-500 font-semibold text-xl'>{`현재 플레이리스트: ${
