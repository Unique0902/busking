    ...
    <>
      <section className='border-gray-600 border-b items-center pb-4 flex flex-row'>
        ...
        <div className='flex flex-row items-center border-l border-gray-400'>
          ...
          {isShowQr && (
            <button
              className='relative font-sans text-lg text-black bg-gray-200 rounded-lg px-3 py-2 mr-3'
              onClick={() => {
                setIsShowQr(false);
              }}
            >
          ...
          {!isShowQr && (
            <button
              className='relative font-sans text-lg ml-4 text-black bg-gray-200 rounded-lg px-3 py-2 mr-3'
              onClick={() => {
                setIsShowQr(true);
              }}
            >
