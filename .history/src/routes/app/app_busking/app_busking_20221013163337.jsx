...
const App_busking = ({ buskingRepository }) => {
  ...
  useEffect(() => {
    buskingRepository.syncBuskingData(userId, (data) => {
      setBuskingData(data);
      setResults(Object.values(data.appliance));
      setResultNum(Object.values(data.appliance).length);
    });
  }, []);
  useEffect(() => {
    if (userId) {
  ...
  useEffect(() => {
    if (buskingData && buskingData.appliance) {
      setResults(Object.values(buskingData.appliance));
      setResultNum(Object.values(buskingData.appliance).length);
    }
  }, [
    buskingData,
    buskingData &&
