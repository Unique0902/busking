...
const App_busking = ({ buskingRepository }) => {
  ...
  return (
    <>
      ...
      <section className='bg-white rounded-2xl m-auto w-3/4 mt-2 p-10 relative'>
        <section className='w-3/4 m-auto bg-gray-300 rounded-3xl text-center py-4 px-2'>
          <div className='font-sans text-xl text-white font-semibold py-2 px-2 w-3/4 m-auto rounded-xl bg-gray-500 mb-2'>
            {isSinging ? (
              <>
