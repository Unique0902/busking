...
const App_busking = ({ buskingRepository }) => {
  ...
  const playBtnStyle = 'mx-1 text-4xl text-black';
  return (
    <>
      <section className='border-gray-600 border-b pb-4 flex flex-row'>
      ...
      <section className='bg-white rounded-2xl m-auto w-3/4 mt-2 py-5 relative'>
        <section className='w-3/4 m-auto bg-blue-300 rounded-3xl text-center py-4 px-2'>
          <div className='font-sans text-xl text-white font-medium py-2 px-2 w-3/4 m-auto rounded-xl bg-blue-500 mb-2'>
            {isSinging ? (
              <>
