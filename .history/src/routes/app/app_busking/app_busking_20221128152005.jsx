      ...
      <section className='bg-white rounded-2xl m-auto w-3/4 mt-8 p-10 relative'>
        <section className='relative flex justify-center items-center mb-6'>
          ...
          <div className='relative'>
            <button
              className='ml-8 bg-blue-600 py-2 px-3 text-lg rounded-lg text-white hover:scale-125'
              onClick={() => {
          ...
          <button
            className='ml-4 bg-blue-600 py-2 px-3 text-lg rounded-lg text-red-400 hover:scale-125'
            onClick={() => {
