      ...
      >
        {!isHide && (
          <div className='flex items-center py-3 px-5  border-solid text-white border-gray-600 border-b'>
            <FontAwesomeIcon
              icon={faBookOpen}
              className={`${iconStyle} text-2xl text-mainBlue`}
            />
            ...
            <>
              <li>
                <button
                  ...
                  className={`${btnStyle} ${
                    selectedBtn === 'home' ? 'text-mainBlue' : 'text-white'
              ...
              <li>
                <button
                  ...
                  className={`${btnStyle} ${
                    selectedBtn === 'add' ? 'text-mainBlue' : 'text-white'
                  } `}
                >
              ...
              <li>
                <button
                  ...
                  className={`${btnStyle} ${
                    selectedBtn === 'playlist' ? 'text-mainBlue' : 'text-white'
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`${btnStyle} ${
                    selectedBtn === 'inform' ? 'text-mainBlue' : 'text-white'
                  }`}
                >
