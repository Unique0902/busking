...
const Sidebar = (props) => {
  ...
  const btnStyle =
    'text-white pl-5 py-4 font-sans text-left font-medium text-lg ';
  ...
  return (
    <>
      ...
      >
        {!isHide && (
          <div className='flex items-center py-3 w-full  border-solid text-white border-gray-300 border-b'>
