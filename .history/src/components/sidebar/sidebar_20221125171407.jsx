      ...
      >
        {!isHide && (
          <div className='flex items-center py-3 px-5  border-solid text-white border-gray-300 border-b'>
            <FontAwesomeIcon icon={faBookOpen} className='text-3xl mr-5' />
            ...
            <>
              <li>
                <button
                  ...
                  className='text-white flex justify-around items-center pl-5 pr-20 w-full py-4 font-sans text-lg border-solid border-gray-300 border-b-10'
                >
