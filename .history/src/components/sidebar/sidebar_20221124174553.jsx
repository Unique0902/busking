      ...
      >
        {!isHide && (
          <div className='flex items-center p-2 border-solid border-gray-300 border-b'>
            ...
            />
            <p className='font-sans text-3xl font-medium text-white'>노래책</p>
          </div>
        )}
            ...
            <>
              <li>
                <button
                  ...
                  className='text-white flex justify-between items-center px-20 w-full py-4 font-sans text-xl border-solid border-gray-300 border-b-10'
                >
