...
const AdditionalMenu = ({ setIsShowAdditionalMenu }) => {
  ...
  const btnStyle = 'font-sans text-black text-lg text-left py-1 px-5';
  useEffect(() => {
  ...
  return (
    ...
    >
      <section className=' border-b border-gray-600 border-solid flex flex-col'>
        <button className=' text-left text-blue-600 font-sans text-xl py-1 mt-2 hover:bg-gray-200 px-5'>
          Playlist1
        </button>
        <button className=' text-left text-black font-sans text-lg py-1 px-5'>
          플레이리스트 추가
        </button>
