...
const AdditionalMenu = ({ setIsShowAdditionalMenu }) => {
  ...
  const btnStyle = 'font-sans text-black';
  useEffect(() => {
  ...
  return (
    ...
    >
      <section className=' border-b border-gray-600 border-solid p-3 flex flex-col'>
        <button className=' text-left text-blue-600 font-sans'>
          Playlist1
        </button>
        <button className=' text-left text-black font-sans'>
          플레이리스트 추가
        </button>
        <button className=' text-left'>플레이리스트 제거</button>
      </section>
      <section>
        <p>모든 플레이리스트</p>
