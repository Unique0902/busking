...
const Login_nav = (props) => {
  return (
    <nav className='flex items-center justify-around'>
      ...
      <ul className='w-2/5 justify-around font-sans hover:scale-110 text-xl text-black font-semibold flex'>
        <li>
      ...
      <button className='text-white py-2 px-4 font-light font-sans text-base bg-blue-700 rounded-3xl'>
        튜토리얼
      </button>
    </nav>
  );
